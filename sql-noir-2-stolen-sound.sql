...
-- A prized vinyl record, worth over $10,000, vanished during a busy evening, leaving the store owner
-- desperate for answers. Vaguely recalling the details, you know the incident occurred on July 15, 1983,
-- at this famous store. Your task is to track down the thief and bring them to justice.
...
-- witnesses: id, crime_scene_id, clue
...
-- (West Hollywood Records) to find the incident report. Then, you retrieved the two
-- witness records from the 'witnesses' table, which revealed that: • The suspect wore
